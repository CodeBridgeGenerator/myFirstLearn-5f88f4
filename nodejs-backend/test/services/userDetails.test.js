...
describe("userDetails service", async () => {
  ...
  describe("#create", () => {
    const options = {"firstN":"new value","course":"new value","phoneNo":23};
    ...
    it("should create a new userDetail", () => {
      assert.strictEqual(userDetailCreated.firstN, options.firstN);
assert.strictEqual(userDetailCreated.course, options.course);
assert.strictEqual(userDetailCreated.phoneNo, options.phoneNo);
  ...
  describe("#update", () => {
    const options = {"firstN":"updated value","course":"updated value","phoneNo":100};
    ...
    it("should update an existing userDetail ", async () => {
      ...
      assert.strictEqual(userDetailUpdated.firstN, options.firstN);
assert.strictEqual(userDetailUpdated.course, options.course);
